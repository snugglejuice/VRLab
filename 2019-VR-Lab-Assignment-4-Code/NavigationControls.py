...
class NavigationControls(avango.script.Script):
    ...
    def evaluate(self):
        ...
        picker.compute_pick_result(self.scenegraph['/navigation_node/avatar'].Transform.value.get_translate(),avango.gua.Vec3(0.0, -1.0, 0.0),2,self.scenegraph['/navigation_node/avatar/camera_rot/camera_trans/camera_node'].BlackList)
