...
from lib.ViveNavigationControls import ViveNavigationControls
...
class ViveViewingSetup:
    ...
    def __init__(self, scenegraph):
        ...
        self.controller2_sensor = avango.daemon.nodes.DeviceSensor(
            DeviceService=device_service)
        self.controller2_sensor.Station.value = 'gua-device-hmd-0-2'
        ...
        self.controller1.Transform.connect_from(self.controller1_sensor.Matrix)
        self.navigation_node.Children.value.append(self.controller1)
        self.controller2 = self.create_controller_object()
        self.controller2.Transform.connect_from(self.controller2_sensor.Matrix)
        self.navigation_node.Children.value.append(self.controller2)

        # navigation controls
        self.navigation_controls = ViveNavigationControls()
        self.navigation_controls.set_nodes(self.scenegraph, self.navigation_node,
                                           self.camera_node, self.controller1_sensor, self.controller1)
    ...
    def register_window(self, window):
        ...
        window.register_node(self.controller1, 1)
        window.register_node(self.controller2, 2)
